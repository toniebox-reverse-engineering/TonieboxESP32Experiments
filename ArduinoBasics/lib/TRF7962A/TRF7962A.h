...
class TRF7962A {
    public:
        ...
        static void receivedInterruptStatic();
...
*/
        ...
        void handleTagEvent(TAG_EVENT tagEvent);
        void handleResult(ISO15693_RESULT tagResult);
        bool tagActive;
        uint8_t tagUid[8];
        TAG_EVENT lastEvent;
        ISO15693_RESULT lastResult;
        uint8_t spiEnablePin;
        uint8_t rfidIrqPin = 0;
};
#endif